...
const ResumePage: React.FunctionComponent = () => {
    ...
    return (
        <div id="resumeContainer" className="mainContainer flexColumn">
            ...
            <ResumeBlock
                blockType={ResumeBlockType.detail}
                rightJustifiedBlock={true}
                classes={["resumeDetailBlock", "resumePersonalDetails", "oneHundredPercentViewWidth"]}>
                <Heading
                    level={HeadingLevel.h3}
                    value="Jesse Cunningham-Creech"
                    uppercase={true}
                    classes={["nameTitle"]} />
                ...
                <div>
                    ...
                    <Heading
                        level={HeadingLevel.h3}
                        value="hello@jessec.dev"
                        uppercase={true}
                        link="mailto:hello@jessec.dev"
                        classes={["inlineBlock", "marginLeft20px"]} /></div>
                <Heading level={HeadingLevel.h3}
                    value="www.linkedin.com/in/jesse-creech"
                    uppercase={true}
                    link="http://www.linkedin.com/in/jesse-creech"
                    classes={["marginLeft32px"]} />
            </ResumeBlock>

            <ResumeBlock blockType={ResumeBlockType.detail}
                rightJustifiedBlock={true}
                classes={["resumeCopyBlock"]}>
                <p>I am a Web Developer with a good knowledge of OO principles. I have extensive knowledge of the enterprise
                software development life cycle as well as previous expertise in front end UX design. I aspire to be a key
                member of a high performing development team, utilising the latest technologies and development practises.
                I look for opportunities that will challenge me so that I can continuously improve as a developer, whilst
                    working on projects that I find fascinating.</p>
            </ResumeBlock>
            ...
            <ResumeBlock
                blockType={ResumeBlockType.detail}
                rightJustifiedBlock={true}
                classes={["resumeJobBlock", "oneHundredPercentViewWidth", "flexRow", "flexWrap"]}>
